                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Agregando</strong> Clientes
                        </div>
                            ...
                            <form action="controllers/customer-controller.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <small class="form-text text-muted">Introduzca sus nombres</small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <small class="form-text text-muted">Introduzca sus apellidos</small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <small class="form-text text-muted">Correo del Cliente</small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="number" id="txt-salary" name="txt-salary" placeholder="1000" class="form-control" required min="1">
