                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($resultado) > 0) {
                                            ...
                                            while ($fila = mysqli_fetch_assoc($resultado)) {
                                                echo "<tr>";
                                                echo "<td>" . $dataN . "</td>";
                                                echo "<td>" . $fila['Moneylender'] . "</td>";
                                                echo "<td>" . $fila['TotalAmount'] . "</td>";
                                                echo "<td>" . $fila['Interest'] . "</td>";
                                                echo "<td>$" . $fila['Amount'] . "</td>";
                                                echo "<td>$" . $fila['MonthlyPayment'] . "</td>";
                                                echo "<td>" . $fila['PaymentDeadline'] . " años</td>";
                                                if($fila['Status'] == 'En espera'){
                                                    echo '<td><center><span class="badge badge-secondary">' . $fila['Status'] . '</span></center></td>';
                                                    echo '<td><a class="btn btn-danger" href="controllers/customer-transactions-contoller.php?idLending='. $fila['ID_Lending'] .'& action=eliminar" role="button"><i class="fa-solid fa-trash-can"></i></a></td>';
                                                }else{
                                                    echo '<td><center><span class="badge badge-primary">' . $fila['Status'] . '</span></center></td>';
                                                    echo '<td><a class="btn btn-danger" href="" role="button"><i class="fa-solid fa-trash-can"></i></a></td>';
                                                }
