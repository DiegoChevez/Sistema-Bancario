        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    $sql2 = "SELECT l.*,CONCAT(c.`Names`, ' ', c.`Surnames`) AS FullName FROM lendings l INNER JOIN customers c ON c.`UserAccount` = l.`Moneylender` WHERE l.`Moneylender`='".$idCliente."'";
                            ...
                            if($fila2['Status'] == 'Activo'){
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mx-auto d-block">
                                            <img class="mx-auto d-block" src="images/card.png" alt="Card image cap" style="width: 30%;">
                                            <h5 class="text-sm-center mt-2 mb-1">Prestamo</h5>
                                            <div class="location text-sm-center"><i class="fa-solid fa-id-card-clip"></i> ' . $fila2['FullName'] . ' </div>
                                        </div>
                                        <hr>
                                        <div class="card-text text-sm-center">
                                            <h5 class="text-sm-center mt-2 mb-1" style="color:#146551; font-weight: bold;">Saldo: $'.$fila2['TotalAmount'].'</h5>
                                        </div>
                                    </div>
                                    <div class="card-footer text-sm-center">
                                        <a class="btn btn-outline-secondary btn-sm" href="lending-payments.php?idLending='.$fila2['ID_Lending'].'" role="button">Pagos</a>
                                        <a class="btn btn-outline-info btn-sm" href="lending-new-payment.php?idLending='.$fila2['ID_Lending'].'" role="button"><i class="fa-solid fa-plus"></i> Pagar</a>
                                    </div>
                                </div>
                            </div>';
                            }else{
                    ...
                    if(mysqli_num_rows($resultado2) == 0){
                        echo '<div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mx-auto d-block">
                                            <h5 class="text-sm-center mt-2 mb-1"><a href="lendings-creator.php?idPerson='.$idCliente.'"><i class="fa-solid fa-circle-plus text-sm-center" style="font-size: 18rem;"></i></a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>';
