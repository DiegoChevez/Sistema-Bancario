                        ...
                        <div class="card text-white bg-flat-color-1">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <a href="customer-accounts.php?idPerson=<?php echo $id_User?>" class="text-light">Cuentas</a>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Targetas</p>
                                </div><!-- /.card-left -->

                                <div class="card-right float-right text-right">
                                    <i class="icon fade-5 icon-lg pe-7s-wallet"></i>
                                </div><!-- /.card-right -->
                    ...
                    <div class="col-lg-3 col-lg-6">
                        <div class="card text-white bg-flat-color-3">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <a href="customer-lending.php?idPerson=<?php echo $id_User ?>" class="text-light">Prestamos</a>
                                    </h3>
