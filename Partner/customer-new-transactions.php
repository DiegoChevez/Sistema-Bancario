...
if (isset($_GET['idCuenta'])) {
    ...
    $sql = "SELECT * FROM accounts WHERE `ID_Account` = '".$idCuenta."'";
    $result = $conex->query($sql);
    $datos = $result->fetch_assoc();
    $accountType = $datos["AccountType"];
} else {
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="header-content" style="display: flex; align-items: center; gap: 10px;">
                <a href="customer-accounts.php?idPerson=<?php echo $_IdUser ?>" style="font-size: 1.5rem;"><i class="fa-regular fa-circle-left"></i></a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            if($accountType == 'Empresarial'){
                                echo '<div class="row form-group" id="div-TipoTransaccion">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="txt-TipoTransaccion" id="txt-TipoTransaccion" class="form-control" required>
                                        <option value="" disabled selected>Seleccione el tipo de transaccion</option>
                            ...
                            ?>
                                ...
                                <script>
                                    ...
                                    select.addEventListener("change", function() {
                                        if (select.value === "Transaccion" || select.value === "Retiro") {
